...
// args
$args = array(
    'numberposts' => 18,'posts_per_page' => 18, 'post_type' => 'member', 'orderby' => 'rand', 'meta_query' => array( array( 'key' => 'gallery_images', 'value' => 0, 'type' => 'NUMERIC','compare' => '>')));
    ...
    <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
			<a class="link-img-wrap" href="<?php the_permalink() ?>">
					...
					if($rows = get_field('gallery_images' )) {
						echo '<div class="fwrap" style="background-image:url('.$rand_row_image['sizes']['medium'] .');">';
					} else {
